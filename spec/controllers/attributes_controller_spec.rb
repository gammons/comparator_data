  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attribute as @attribute" do
        ...
        post :create, {:attribute => { "name" => "invalid value" }}, valid_session
        assigns(:attribute).should be_a_new(Attribute)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attribute" do
        ...
        Attribute.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => attribute.to_param, :attribute => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the attribute as @attribute" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Attribute.any_instance.stub(:save).and_return(false)
        put :update, {:id => attribute.to_param, :attribute => { "name" => "invalid value" }}, valid_session
        assigns(:attribute).should eq(attribute)
      end
